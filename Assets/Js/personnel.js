...
form.onsubmit = (e) => {
    ...
    const telefono = document.getElementById("newPhone").value;

    // Llamamos a la función que crea la fila en la tabla
    agregarPersonal(nombre, cargo, telefono, "Activo");
...
function agregarPersonal(nombre, cargo, telefono, estado) {
    const tabla = document.getElementById('personnel-body');
